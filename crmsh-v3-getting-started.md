...
Noch nicht installiert? Bitte folgen Sie den Installationsanweisungen, bevor Sie diese Anleitung fortsetzen. Nur Crmsh und seine Abhängigkeiten müssen installiert werden, bevor Sie diese Anleitung folgen.
...
Dies sind die in diesem Leitfaden verwendeten Geräte. Bitte ersetzen Sie die Verweise auf diese Namen und IP-Adressen auf die für Ihren Cluster geeigneten Werte:
```
Name IP
