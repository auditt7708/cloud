...
* 1. Volumes, die über Host-Rechner mit der Option --volume montiert werden

* 2. Volumes, die über einen anderen Container mit der Option --volumes-from montiert werden
