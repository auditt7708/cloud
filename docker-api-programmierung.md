...
In diesem Kapitel schauen wir in die Docker-Daemon-Remote-API und verwenden den `Curl`-Befehl (http://curl.haxx.se/docs/manpage.html), um mit den Endpunkten verschiedener APIs zu kommunizieren, die wie folgt aussehen werden Befehl:
